...
; *** Application titles
SetupAppTitle=Установка ProjectArcade
SetupWindowTitle=Установка ProjectArcade
UninstallAppTitle=Деинсталляция ProjectArcade
UninstallAppFullTitle=Деинсталляция ProjectArcade
...
SetupFileMissing=Файл %1 отсутствует в папке установки. Пожалуйста, устраните проблему или загрузите установщик ProjectArcade заново.
SetupFileCorrupt=Установочные файлы повреждены. Пожалуйста, загрузите установщик ProjectArcade заново.
SetupFileCorruptOrWrongVer=Эти установочные файлы повреждены или несовместимы с данной версией установщика. Пожалуйста, устраните проблему или загрузите установщик ProjectArcade заново.
...
ExitSetupMessage=Установка не завершена. Если вы выйдете, ProjectArcade не будет установлен.%n%nВы сможете завершить установку, запустив программу установки позже.%n%nВыйти из программы установки?
AboutSetupMenuItem=&О программе...
AboutSetupTitle=О программе
AboutSetupMessage=%1, версия %2%n%3%n%nСайт %1:%n%4
AboutSetupNote=ProjectArcade
TranslatorNote=Russian translation by #TheDayG0ne (for ProjectArcade)
; *** Buttons
ButtonBack=< &Назад
ButtonNext=&Далее >
...
SelectLanguageLabel=Выберите язык, который будет использован в процессе установки ProjectArcade.
...
WelcomeLabel2=Программа установит [name/ver] на ваш компьютер.%n%nПеред тем, как продолжить процесс установки, рекомендуется сохранить все несохраненные файлы, а также закрыть все приложения, которые могут помешать установке.

; *** "Password" wizard page
WizardPassword=Пароль
PasswordLabel1=Эта программа защищена паролем.
PasswordLabel3=Пожалуйста, введите пароль, потом нажмите «Далее». Пароли необходимо вводить с учётом регистра.
...
LicenseLabel=Пожалуйста, прочтите лицензионное соглашение. 
LicenseLabel3=Вы должны принять условия этого соглашения перед тем, как продолжить установку.
...
WizardInfoBefore=Системные требования
InfoBeforeLabel=Пожалуйста, убедитесь в соответствии вашего ПК с указанными ниже системными требованиями ProjectArcade.
InfoBeforeClickLabel=Когда вы будете готовы продолжить установку, нажмите «Далее».
WizardInfoAfter=Информация
InfoAfterLabel=Пожалуйста, прочитайте следующую информацию перед тем, как продолжить.
...
InstallingLabel=Пожалуйста, подождите, пока [name] устанавливается на ваш компьютер.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Завершение программы установки [name]
FinishedLabelNoIcons=[name] установлен на ваш компьютер.
FinishedLabel=[name] установлен на ваш компьютер. Приложение можно запустить с помощью соответствующего значка.
...
ProgramOnTheWeb=Посетить сайт %1
