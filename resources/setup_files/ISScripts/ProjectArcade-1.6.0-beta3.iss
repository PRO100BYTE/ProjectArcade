...
#define MyAppVersion "1.6.0-beta3"
...
OutputDir=P:\Software\ProjectArcade\ProjectArcade-setupbuilds\1.6.0-beta3\
OutputBaseFilename=ProjectArcade-1.6.0-beta3_setup
...
[Files]
Source: "P:\Software\ProjectArcade\ProjectArcade-builds\1.6.0-beta3\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion;
Source: "P:\Software\ProjectArcade\ProjectArcade-builds\1.6.0-beta3\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "P:\Software\ProjectArcade\ProjectArcade-builds\1.6.0-beta3\projectarcade.ini"; DestDir: "{app}"; Flags: ignoreversion;
Source: "P:\Software\ProjectArcade\ProjectArcade-builds\1.6.0-beta3\emulationstation\about.info"; DestDir: "{app}\emulationstation"; Flags: ignoreversion; 
; Attribs: readonly;
Source: "P:\Software\ProjectArcade\ProjectArcade-builds\1.6.0-beta3\emulationstation\version.info"; DestDir: "{app}\emulationstation"; Flags: ignoreversion
; Attribs: readonly; 
